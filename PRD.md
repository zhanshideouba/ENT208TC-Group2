...
## 3. User Stories (5–7 Requirement)
...
**Input Layer (Sensors):** PIR Motion, Photoresistor, Current Sensor (CT Clamp/ACS712).

**Processing Layer (MCU):** **ESP32 Microcontroller** (Handles logic and local data storage).

**Output Layer (UI):** **OLED Screen (Data), RGB LED Ring (Status), Piezo Buzzer (Audio).**

**Power:** Mains pass-through (Plug-in) with optional battery backup.

## 6. Success Metrics (KPIs)
**Onboarding:** Setup time **< 1 minute**.

**Usability:** **90% of users** correctly identify alert signals.

**Behavioral Impact:** **Downward trend** in daily waste alerts over 7 days.
